...
public class DetailKarakterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load(getIntent().getStringExtra("fotoKarakter")).into(ivGambarKarakter);
        Glide.with(this).load(getIntent().getStringExtra("rarityKarakter")).into(ivRarityKarakter);
        Glide.with(this).load(getIntent().getStringExtra("iconWeapon")).into(ivGambarSenjata);
